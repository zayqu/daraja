...
- `WHATSAPP_SANDBOX_EVIDENCE_ID`, an internal reference to the retained test
  result
- `WHATSAPP_SANDBOX_WEBHOOK_EVIDENCE_ID`, an internal reference to the retained
  delivery-status webhook result
- `WHATSAPP_SANDBOX_VERIFIED_AT`, the completed test time in canonical ISO 8601
  format, no more than 30 days old
