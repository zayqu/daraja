    ...
    <>
      ...
      <main className={styles.shell} id="main-content">
        <header className={styles.header}>
          ...
          <span>
            Build one reusable profile, save suitable vacancies and track Daraja
        ...
        <section className={styles.grid} aria-label="Career tools">
          <article className={styles.card}>
            ...
            <p>
              Maintain your professional headline and preferences. CVs and
              supporting documents are private and are not accepted as public
              profile links.
            </p>
          </article>
          <article className={styles.card}>
            <h2>Saved jobs</h2>
            <p>
              Keep vacancies together without changing their official
          ...
          <article className={styles.card}>
            <h2>Applications</h2>
            <p>
              Track submitted, reviewed, shortlisted, offered, rejected or
